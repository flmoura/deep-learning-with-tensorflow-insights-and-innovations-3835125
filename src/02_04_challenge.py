...
normalized_tensor = tf.cast(tensor, tf.float32) / 9.0  # Replace with your code
...
mean = tf.reduce_mean(normalized_tensor)  # Replace with your code
std_dev = tf.math.reduce_std(normalized_tensor)  # Replace with your code
